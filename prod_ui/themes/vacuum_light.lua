return {
	...
	scroll_bar_data = {
		scroll_bar1 = {
			body_color = {0.7, 0.7, 0.7, 1.0},
			col_trough = {0.7, 0.7, 0.7, 1.0},
			shared = {
				idle = {
					col_body = {1.0, 1.0, 1.0, 1.0},
					col_symbol = {1.0, 1.0, 1.0, 1.0}
				},
				hover = {
					col_body = {1.0, 1.0, 1.0, 1.0},
					col_symbol = {1.0, 1.0, 1.0, 1.0}
	...
	skins = {
		...
		dropdown_pop1 = {
			color_body = {1.0, 1.0, 1.0, 1.0},
			color_text = {0.1, 0.1, 0.1, 1.0},
			color_selected = {0.75, 0.75, 0.75, 0.33}
		},
		group1 = {
			color_text = {0.1, 0.1, 0.1, 1.0},
		...
		menu_pop1 = {
			...
			color_select_glow = {0.5, 0.5, 0.5, 0.5},
		...
		menu_tab1 = {
			color_header_body = {0.75, 0.75, 0.75, 1.0},
			color_background = {0.8, 0.8, 0.8, 1.0},
			color_item_text = {0.1, 0.1, 0.1, 1.0},
			color_select_glow = {1.0, 1.0, 1.0, 0.33},
		...
		progress_bar1 = {
			...
			res_inactive = {
				...
				color_label = {0.33, 0.33, 0.33, 1.0},
			}
		},
		properties_box1 = {
			color_item_text = {0.1, 0.1, 0.1, 1.0},
