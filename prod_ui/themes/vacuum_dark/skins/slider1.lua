return {
	...
	res_idle = {
		tq_thumb = "*quads/slider_thumb1", -- XXX make some variations for hover, press, disabled
		sl_trough_active = "*slices/slider_trough_active",
		sl_trough_empty = "*slices/slider_trough_empty",
