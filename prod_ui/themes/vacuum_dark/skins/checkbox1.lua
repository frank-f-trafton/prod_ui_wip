return {
	...
	res_idle = {
		quad_checked = "*quads/checkbox_on",
		quad_unchecked = "*quads/checkbox_off",
	...
	res_hover = {
		quad_checked = "*quads/checkbox_on_hover",
		quad_unchecked = "*quads/checkbox_off_hover",
	...
	res_pressed = {
		quad_checked = "*quads/checkbox_on_press",
		quad_unchecked = "*quads/checkbox_off_press",
