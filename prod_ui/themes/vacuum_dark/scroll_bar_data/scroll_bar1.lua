return {
	tquad_pixel = "*quads/pixel",
	tq_arrow_down = "*quads/arrow2_down",
	tq_arrow_up = "*quads/arrow2_up",
	tq_arrow_left = "*quads/arrow2_left",
	tq_arrow_right = "*quads/arrow2_right",
	...
	shared = {
		idle = {
			slice = "*slices/scroll_button",
			col_body = {1.0, 1.0, 1.0, 1.0},
			col_symbol = {0.65, 0.65, 0.65, 1.0},
		},
		hover = {
			slice = "*slices/scroll_button_hover",
			col_body = {1.0, 1.0, 1.0, 1.0},
			col_symbol = {0.75, 0.75, 0.75, 1.0},
		},
		press = {
			slice = "*slices/scroll_button_press",
			col_body = {1.0, 1.0, 1.0, 1.0},
			col_symbol = {0.3, 0.3, 0.3, 1.0},
		},
		disabled = {
			slice = "*slices/scroll_button_disabled",
