...
--- The default thimble renderer. You don't normally have to assign this, since it's attached to the
--	default widget metatable.
function widShared.renderThimble(self, ox, oy)
