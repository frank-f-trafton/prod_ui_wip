...
-- @param func The function to call. It should take 'self' as its first argument; pass any variadic functions along, as well. It should return values that control if and how the lineEditor object is updated. For more info, see the func(self) call here, and also in EditAct.
