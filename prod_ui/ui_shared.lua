...
uiShared.fieldType = pArgCheck.fieldType -- (t, tn, f, ...)
uiShared.fieldTypeEval = pArgCheck.fieldTypeEval -- (t, tn, f, ...)
uiShared.fieldType1 = pArgCheck.fieldType1 -- (t, tn, f, e)
uiShared.fieldTypeEval1 = pArgCheck.fieldTypeEval1 -- (t, tn, f, e)
uiShared.fieldInt = pArgCheck.fieldInt -- (t, tn, f)
uiShared.fieldIntEval = pArgCheck.fieldIntEval -- (t, tn, f)
uiShared.fieldIntGE = pArgCheck.fieldIntGE -- (t, tn, f, min)
uiShared.fieldIntGEEval = pArgCheck.fieldIntGEEval -- (t, tn, f, min)
uiShared.fieldIntRange = pArgCheck.fieldIntRange -- (t, tn, f, min, max)
uiShared.fieldIntRangeEval = pArgCheck.fieldIntRangeEval -- (t, tn, f, min, max)
uiShared.fieldIntRangeStatic = pArgCheck.fieldIntRangeStatic -- (t, tn, f, min, max)
uiShared.fieldIntRangeStaticEval = pArgCheck.fieldIntRangeStaticEval -- (t, tn, f, min, max)
uiShared.fieldNumberNotNaN = pArgCheck.fieldNumberNotNaN -- (t, tn, f)
uiShared.fieldNumberNotNaNEval = pArgCheck.fieldNumberNotNaNEval -- (t, tn, f)
uiShared.fieldEnum = pArgCheck.fieldEnum -- (t, tn, f, id, e)
uiShared.fieldEnumEval = pArgCheck.fieldEnumEval -- (t, tn, f, id, e)
uiShared.fieldNotNil = pArgCheck.fieldNotNil -- (t, tn, f)
uiShared.fieldNotNilNotNaN = pArgCheck.fieldNotNilNotNaN -- (t, tn, f)
uiShared.fieldNotNilNotFalse = pArgCheck.fieldNotNilNotFalse -- (t, tn, f)
uiShared.fieldNotNilNotFalseNotNaN = pArgCheck.fieldNotNilNotFalseNotNaN -- (t, tn, f)
uiShared.fieldNotNaN = pArgCheck.fieldNotNaN -- (t, tn, f)
