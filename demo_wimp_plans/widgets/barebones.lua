...
function plan.make(panel)
	...
	bb_rep:geometrySetMode("static", xx, yy, ww, hh)
	...
	bb_instant:geometrySetMode("static", xx, yy, ww, hh)
	...
	bb_stick:geometrySetMode("static", xx, yy, ww, hh)
	...
	bb_checkbox:geometrySetMode("static", xx, yy, ww, hh)
	...
	bb_radio:geometrySetMode("static", xx, yy, ww, hh)
	...
	bb_lbl:geometrySetMode("static", xx, yy, ww, hh)
	bb_lbl.enabled = true
	...
	bb_sl1:geometrySetMode("static", xx, yy, ww, hh)
	...
	bb_sl2:geometrySetMode("static", xx, yy, hh, ww)
	...
	bb_input:geometrySetMode("static", xx, yy, ww, 32)
